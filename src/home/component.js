...
var HomeComponent = /** @class */ (function () {
    ...
    HomeComponent.prototype.ngAfterViewInit = function () {
        //this.jsreports();
        this.custom_jsreports();
    };
    HomeComponent.prototype.jsreports = function () {
        var dataSources = [{
                "id": "account_detail",
                "name": "Account Detail",
                "data": [{
        ...
        var report = jsreports.createReport('Bank Statement')
            ...
            .text('Please note that due to rounding, percentages may not add to 100%.', 5.25, 4.5, 4.75, 1, { fontsize: 10, wrap: true })
            .text(['Important disclosures: Past results do not guarantee future',
            'returns.  All investments involve risk.'].join(' '), 0, 3.5, 4.75, 1, { fontsize: 10, wrap: true })
    ...
    HomeComponent.prototype.custom_jsreports = function () {
        var items = [{
        ...
        var report = jsreports.createReport()
            .name('Invoice-' + TodayDate.toString())
            .data('Invoice_Data')
